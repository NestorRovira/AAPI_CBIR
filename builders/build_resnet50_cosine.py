...
OUT_DIR = REPO_ROOT / "indices" / "resnet50_cosine"
...
model.fc = torch.nn.Identity()  # -> 2048D
...
embs = np.zeros((len(paths), 2048), dtype=np.float32)
...
print("ResNet50 COSINE index creado:", INDEX_PATH)
